...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ka_range = Range(-4, 20, 0.01, 1, 200)
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "coeficiente de sencibilidad", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 500e-3, 0.01, 0.25, 200)
        ...
        self.CalculoPotencia_1 = CalculoPotencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotencia_1)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.ModuloAm_0, 0), (self.blocks_complex_to_real_2, 0))
        ...
        self.connect((self.blocks_complex_to_real_2, 0), (self.CalculoPotencia_1, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.ModuloAm_0.set_ka(self.ka)
