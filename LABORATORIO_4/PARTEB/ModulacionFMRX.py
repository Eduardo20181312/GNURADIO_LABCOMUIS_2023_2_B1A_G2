...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fcb_win = RangeWidget(self._fcb_range, self.set_fcb, "frecuencia de corte de filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(D, firdes.low_pass(1, samp_rate, fcb, 10000, window.WIN_HAMMING, 6.76), 1)
        ...
        self.connect((self.uhd_usrp_source_0, 0), (self.filter_fft_low_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fcb, 10000, window.WIN_HAMMING, 6.76))
