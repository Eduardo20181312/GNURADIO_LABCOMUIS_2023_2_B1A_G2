...
class MultiplexarPAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MultiplexarPAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MultiplexarPAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "MultiplexarPAM")
...
def main(top_block_cls=MultiplexarPAM, options=None):
