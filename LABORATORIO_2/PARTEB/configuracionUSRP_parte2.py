...
class configuracionUSRP_parte2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "configuracionUSRP_parte2")
        ...
        self._fc_range = Range(50000000, 2200000000, 1000000, 200000000, 200)
...
def main(top_block_cls=configuracionUSRP_parte2, options=None):
