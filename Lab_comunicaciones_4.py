...
class Lab_comunicaciones_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "cuarto punto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("cuarto punto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comunicaciones_4")
        ...
        self._amplitud_range = Range(0, 5, 0.2, 5, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frequency, amplitud, 0, 0)
...
def main(top_block_cls=Lab_comunicaciones_4, options=None):
