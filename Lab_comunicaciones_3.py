...
class Lab_comunicaciones_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "tercer punto", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("tercer punto")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_comunicaciones_3")
...
def main(top_block_cls=Lab_comunicaciones_3, options=None):
